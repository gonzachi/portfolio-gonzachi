            ...
            <div className={styles.container}>
                <div className={styles.left}>
                    ...
                    <div className={styles.icons}>
                        <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className={styles.iconLink} aria-label="LinkedIn">
                        ...
                        <a href={personalInfo.behance} target="_blank" rel="noopener noreferrer" className={styles.iconLink} aria-label="Behance">
                        ...
                        <a href={`mailto:${personalInfo.email}`} className={styles.iconLink} aria-label="Email">
