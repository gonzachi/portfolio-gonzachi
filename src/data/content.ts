...
export const landingProjects = [
  ...
  },
  {
    ...
    number: "06",
    title: "Reservadísimo",
    subtitle: "Una plataforma de reservas para bares nacida en pandemia, desde la idea hasta la validación con comercios",
    company: "Proyecto personal · 2020",
    description: "Durante la pandemia, los bares que reabrían bajo protocolos estrictos gestionaban reservas por WhatsApp, redes sociales o teléfono, y al llegar el cliente debía completar una declaración jurada en papel. Diseñé y desarrollé una app donde el usuario pudiera encontrar cualquier bar, reservar de forma autónoma, completar la declaración jurada digitalmente y validar su turno con la compra anticipada de un producto o voucher. Fue un proyecto personal que llegó hasta el MVP; se realizaron presentaciones a bares con una alta tasa de intención de incorporación, aunque no avanzó más allá por una decisión personal de no emprender en ese momento.",
    role: "UX/UI Designer",
    tags: ["Side Project", "MVP", "Marketplace", "Hospitality", "Mobile App", "Product Design"],
    stat: { value: "MVP", label: "end-to-end" },
